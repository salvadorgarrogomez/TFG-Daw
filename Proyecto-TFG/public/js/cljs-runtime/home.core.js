...
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.carousel.slide.container","div.carousel.slide.container",-807774212),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),carousel_id], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.carousel-indicators","div.carousel-indicators",-576266492),cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (i,p__26851){
var map__26852 = p__26851;
var map__26852__$1 = cljs.core.__destructure_map(map__26852);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26852__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
}),imagenes))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.carousel-inner","div.carousel-inner",2016287053),cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (i,p__26858){
var map__26859 = p__26858;
var map__26859__$1 = cljs.core.__destructure_map(map__26859);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26859__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var descripcion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26859__$1,new cljs.core.Keyword(null,"descripcion","descripcion",-1196002063));
var imagen_base64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26859__$1,new cljs.core.Keyword(null,"imagen_base64","imagen_base64",-2118761036));
var mime_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26859__$1,new cljs.core.Keyword(null,"mime_type","mime_type",1613436611));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.row","div.row",133678515),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"containerImg"], null),(function (){var iter__5480__auto__ = (function home$core$mostrar_imagenes_todas_$_iter__26875(s__26876){
return (new cljs.core.LazySeq(null,(function (){
var s__26876__$1 = s__26876;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26876__$1);
if(temp__5804__auto__){
var s__26876__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26876__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__26876__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__26878 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__26877 = (0);
while(true){
if((i__26877 < size__5479__auto__)){
var idx = cljs.core._nth(c__5478__auto__,i__26877);
cljs.core.chunk_append(b__26878,(function (){var map__26887 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(imagenes,idx);
var map__26887__$1 = cljs.core.__destructure_map(map__26887);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26887__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var descripcion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26887__$1,new cljs.core.Keyword(null,"descripcion","descripcion",-1196002063));
var imagen_base64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26887__$1,new cljs.core.Keyword(null,"imagen_base64","imagen_base64",-2118761036));
var mime_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26887__$1,new cljs.core.Keyword(null,"mime_type","mime_type",1613436611));
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-12.col-md-5.conjuntoImagenes","div.col-12.col-md-5.conjuntoImagenes",735623809),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__26877,map__26887,map__26887__$1,id,descripcion,imagen_base64,mime_type,base64_src,idx,c__5478__auto__,size__5479__auto__,b__26878,s__26876__$2,temp__5804__auto__,imagenes){
return (function (){
...
});})(i__26877,map__26887,map__26887__$1,id,descripcion,imagen_base64,mime_type,base64_src,idx,c__5478__auto__,size__5479__auto__,b__26878,s__26876__$2,temp__5804__auto__,imagenes))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26878),home$core$mostrar_imagenes_todas_$_iter__26875(cljs.core.chunk_rest(s__26876__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26878),null);
}
} else {
var idx = cljs.core.first(s__26876__$2);
return cljs.core.cons((function (){var map__26909 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(imagenes,idx);
var map__26909__$1 = cljs.core.__destructure_map(map__26909);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26909__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var descripcion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26909__$1,new cljs.core.Keyword(null,"descripcion","descripcion",-1196002063));
var imagen_base64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26909__$1,new cljs.core.Keyword(null,"imagen_base64","imagen_base64",-2118761036));
var mime_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26909__$1,new cljs.core.Keyword(null,"mime_type","mime_type",1613436611));
var base64_src = ["data:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(mime_type),";base64,",cljs.core.str.cljs$core$IFn$_invoke$arity$1(imagen_base64)].join('');
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-12.col-md-5.conjuntoImagenes","div.col-12.col-md-5.conjuntoImagenes",735623809),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__26909,map__26909__$1,id,descripcion,imagen_base64,mime_type,base64_src,idx,s__26876__$2,temp__5804__auto__,imagenes){
return (function (){
return cljs.core.reset_BANG_(home.core.selected_image,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),base64_src,new cljs.core.Keyword(null,"alt","alt",-3214426),descripcion], null));
});})(map__26909,map__26909__$1,id,descripcion,imagen_base64,mime_type,base64_src,idx,s__26876__$2,temp__5804__auto__,imagenes))
], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),base64_src,new cljs.core.Keyword(null,"alt","alt",-3214426),descripcion], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx)].join('')], null));
})(),home$core$mostrar_imagenes_todas_$_iter__26875(cljs.core.rest(s__26876__$2)));
}
} else {
return null;
}

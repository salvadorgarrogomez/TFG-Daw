...
var bide$core$IRouter$_navigate$dyn_12327 = (function (_,loc,params,query){
var x__5350__auto__ = (((_ == null))?null:_);
var m__5351__auto__ = (bide.core._navigate[goog.typeOf(x__5350__auto__)]);
if((!((m__5351__auto__ == null)))){
return (m__5351__auto__.cljs$core$IFn$_invoke$arity$4 ? m__5351__auto__.cljs$core$IFn$_invoke$arity$4(_,loc,params,query) : m__5351__auto__.call(null, _,loc,params,query));
} else {
var m__5349__auto__ = (bide.core._navigate["_"]);
if((!((m__5349__auto__ == null)))){
return (m__5349__auto__.cljs$core$IFn$_invoke$arity$4 ? m__5349__auto__.cljs$core$IFn$_invoke$arity$4(_,loc,params,query) : m__5349__auto__.call(null, _,loc,params,query));
} else {
...
return bide$core$IRouter$_navigate$dyn_12327(_,loc,params,query);
}
});

var bide$core$IRouter$_replace$dyn_12328 = (function (_,loc,params,query){
var x__5350__auto__ = (((_ == null))?null:_);
var m__5351__auto__ = (bide.core._replace[goog.typeOf(x__5350__auto__)]);
if((!((m__5351__auto__ == null)))){
return (m__5351__auto__.cljs$core$IFn$_invoke$arity$4 ? m__5351__auto__.cljs$core$IFn$_invoke$arity$4(_,loc,params,query) : m__5351__auto__.call(null, _,loc,params,query));
} else {
var m__5349__auto__ = (bide.core._replace["_"]);
if((!((m__5349__auto__ == null)))){
return (m__5349__auto__.cljs$core$IFn$_invoke$arity$4 ? m__5349__auto__.cljs$core$IFn$_invoke$arity$4(_,loc,params,query) : m__5349__auto__.call(null, _,loc,params,query));
} else {
...
return bide$core$IRouter$_replace$dyn_12328(_,loc,params,query);
}
});
...
var bide$core$IPathRepr$_repr$dyn_12329 = (function (_){
var x__5350__auto__ = (((_ == null))?null:_);
var m__5351__auto__ = (bide.core._repr[goog.typeOf(x__5350__auto__)]);
if((!((m__5351__auto__ == null)))){
return (m__5351__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5351__auto__.cljs$core$IFn$_invoke$arity$1(_) : m__5351__auto__.call(null, _));
} else {
var m__5349__auto__ = (bide.core._repr["_"]);
if((!((m__5349__auto__ == null)))){
...
return bide$core$IPathRepr$_repr$dyn_12329(_);
}
});
...
var vec__12259 = cljs.core.vec(bide.impl.router.match(router,path));
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12259,(0),null);
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12259,(1),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12259,(2),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (router,p__12266){
var vec__12267 = p__12266;
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12267,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12267,(1),null);
return bide.impl.router.insert(router,path,name);
 ...
 */
bide.core.start_BANG_ = (function bide$core$start_BANG_(router,p__12296){
var map__12298 = p__12296;
var map__12298__$1 = cljs.core.__destructure_map(map__12298);
var opts = map__12298__$1;
var on_navigate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12298__$1,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908));
var default$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12298__$1,new cljs.core.Keyword(null,"default","default",-1987822328));
var html5_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__12298__$1,new cljs.core.Keyword(null,"html5?","html5?",-1008298421),false);
var html5history = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12298__$1,new cljs.core.Keyword(null,"html5history","html5history",-1921478143));
...
var vec__12304 = _match(event.token);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12304,(0),null);
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12304,(1),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12304,(2),null);
...
var or__5002__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(bide.core.resolve,router,default$__$1);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return "/";
...
var history__$1 = (cljs.core.truth_(html5_QMARK_)?(function (){var G__12307 = html5history__$1;
G__12307.setPathPrefix("");

G__12307.setUseFragment(false);

G__12307.setEnabled(true);

return G__12307;
})():(function (){var G__12308 = html5history__$1;
G__12308.setUseFragment(true);

G__12308.setEnabled(true);

return G__12308;
})());
var initial_token = _initial_token(history__$1);
var initial_loc = _match(initial_token);
var lkey = goog.events.listen(history__$1,goog.history.EventType.NAVIGATE,_on_navigate);
history__$1.replaceToken(initial_token);

var x12309 = router;
(x12309.close = (function (){
var _ = this;
goog.events.unlistenByKey(lkey);

return history__$1.setEnabled(false);
}));

(x12309.bide$core$IRouter$ = cljs.core.PROTOCOL_SENTINEL);

(x12309.bide$core$IRouter$_navigate$arity$4 = (function (_,id,params,query){
var ___$1 = this;
var temp__5804__auto__ = bide.core.resolve.cljs$core$IFn$_invoke$arity$4(router,id,params,query);
if(cljs.core.truth_(temp__5804__auto__)){
var path = temp__5804__auto__;
return history__$1.setToken(path);
} else {
return null;
}
}));

(x12309.bide$core$IRouter$_replace$arity$4 = (function (_,id,params,query){
var ___$1 = this;
var temp__5804__auto__ = bide.core.resolve.cljs$core$IFn$_invoke$arity$4(router,id,params,query);
if(cljs.core.truth_(temp__5804__auto__)){
var path = temp__5804__auto__;
return history__$1.replaceToken(path);
} else {
return null;
}
}));

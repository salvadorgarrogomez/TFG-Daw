...
var G__12503 = o;
reagent.impl.template.goog$module$goog$object.set(G__12503,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__12522__i = 0, G__12522__a = new Array(arguments.length -  0);
while (G__12522__i < G__12522__a.length) {G__12522__a[G__12522__i] = arguments[G__12522__i + 0]; ++G__12522__i;}
  args = new cljs.core.IndexedSeq(G__12522__a,0,null);
} 
...
var G__12504 = o;
reagent.impl.template.goog$module$goog$object.set(G__12504,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__12525__i < G__12525__a.length) {G__12525__a[G__12525__i] = arguments[G__12525__i + 0]; ++G__12525__i;}
  args = new cljs.core.IndexedSeq(G__12525__a,0,null);
} 
...
var G__12505 = props;
var G__12505__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12505,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12505);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12505__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12506 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12506,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12506;
}
})(),id_class);
...
var G__12507 = (cljs.core.count(argv) - first_child);
switch (G__12507) {
case (0):
...
var vec__12508 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12508,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12508,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12508,(2),null);
...
var temp__5808__auto___12528 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12528 == null)){
} else {
var key_12529 = temp__5808__auto___12528;
(jsprops.key = key_12529);
}
...
var temp__5808__auto___12530 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12530 == null)){
} else {
var key_12531 = temp__5808__auto___12530;
(jsprops.key = key_12531);
}
...
var temp__5808__auto___12532 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___12532 == null)){
} else {
var key_12533 = temp__5808__auto___12532;
(jsprops.key = key_12533);
}
...
var temp__5808__auto___12534 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12534 == null)){
} else {
var key_12535 = temp__5808__auto___12534;
(jsprops.key = key_12535);
}
...
var temp__5808__auto___12536 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12536 == null)){
} else {
var key_12537 = temp__5808__auto___12536;
(jsprops.key = key_12537);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12511_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12511_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12512 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12512,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12512,(1),null);
...
break;
default:
var G__12539 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12540 = compiler;
v = G__12539;
compiler = G__12540;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template12518 = (function (opts,id,fn_to_element,parse_fn,meta12519){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12518.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12520,meta12519__$1){
var self__ = this;
var _12520__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12518(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12519__$1));
}));

(reagent.impl.template.t_reagent$impl$template12518.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12520){
var self__ = this;
var _12520__$1 = this;
return self__.meta12519;
}));

(reagent.impl.template.t_reagent$impl$template12518.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12518.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12518.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12518.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12518.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12518.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12519","meta12519",-6231805,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12518.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12518.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12518");

(reagent.impl.template.t_reagent$impl$template12518.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template12518");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12518.
 */
reagent.impl.template.__GT_t_reagent$impl$template12518 = (function reagent$impl$template$__GT_t_reagent$impl$template12518(opts,id,fn_to_element,parse_fn,meta12519){
return (new reagent.impl.template.t_reagent$impl$template12518(opts,id,fn_to_element,parse_fn,meta12519));
});
...
return (new reagent.impl.template.t_reagent$impl$template12518(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});

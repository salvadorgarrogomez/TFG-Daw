...
var G__24339 = o;
reagent.impl.template.goog$module$goog$object.set(G__24339,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__24836__i < G__24836__a.length) {G__24836__a[G__24836__i] = arguments[G__24836__i + 0]; ++G__24836__i;}
  args = new cljs.core.IndexedSeq(G__24836__a,0,null);
} 
...
var G__24341 = o;
reagent.impl.template.goog$module$goog$object.set(G__24341,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__24843__i < G__24843__a.length) {G__24843__a[G__24843__i] = arguments[G__24843__i + 0]; ++G__24843__i;}
  args = new cljs.core.IndexedSeq(G__24843__a,0,null);
} 
...
var G__24353 = props;
var G__24353__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24353,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24353);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24353__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24363 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24363,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24363;
}
})(),id_class);
...
var G__24368 = (cljs.core.count(argv) - first_child);
switch (G__24368) {
case (0):
...
var vec__24393 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24393,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24393,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24393,(2),null);
...
var temp__5808__auto___24850 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___24850 == null)){
} else {
var key_24851 = temp__5808__auto___24850;
...
var temp__5808__auto___24852 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___24852 == null)){
} else {
var key_24853 = temp__5808__auto___24852;
(jsprops.key = key_24853);
}
...
var temp__5808__auto___24854 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___24854 == null)){
} else {
var key_24855 = temp__5808__auto___24854;
...
var temp__5808__auto___24857 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___24857 == null)){
} else {
var key_24858 = temp__5808__auto___24857;
(jsprops.key = key_24858);
}
...
var temp__5808__auto___24859 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___24859 == null)){
} else {
var key_24860 = temp__5808__auto___24859;
(jsprops.key = key_24860);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24547_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24547_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24613 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24613,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24613,(1),null);
...
break;
default:
var G__24866 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__24867 = compiler;
v = G__24866;
compiler = G__24867;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template24810 = (function (opts,id,fn_to_element,parse_fn,meta24811){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template24810.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24812,meta24811__$1){
var self__ = this;
var _24812__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template24810(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta24811__$1));
}));

(reagent.impl.template.t_reagent$impl$template24810.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24812){
var self__ = this;
var _24812__$1 = this;
return self__.meta24811;
}));

(reagent.impl.template.t_reagent$impl$template24810.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template24810.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template24810.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template24810.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template24810.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template24810.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta24811","meta24811",-1856346049,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template24810.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template24810.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template24810");

(reagent.impl.template.t_reagent$impl$template24810.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template24810");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template24810.
 */
reagent.impl.template.__GT_t_reagent$impl$template24810 = (function reagent$impl$template$__GT_t_reagent$impl$template24810(opts,id,fn_to_element,parse_fn,meta24811){
return (new reagent.impl.template.t_reagent$impl$template24810(opts,id,fn_to_element,parse_fn,meta24811));
});
...
return (new reagent.impl.template.t_reagent$impl$template24810(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});

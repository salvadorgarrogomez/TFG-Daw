...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12395 = c;
var G__12395__$1 = (((G__12395 == null))?null:G__12395.prototype);
if((G__12395__$1 == null)){
return null;
} else {
return G__12395__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12397 = c;
var G__12397__$1 = (((G__12397 == null))?null:G__12397.prototype);
if((G__12397__$1 == null)){
return null;
} else {
return G__12397__$1.render;
}
})() == null)))));
});
...
while (G__12483__i < G__12483__a.length) {G__12483__a[G__12483__i] = arguments[G__12483__i + 0]; ++G__12483__i;}
  args = new cljs.core.IndexedSeq(G__12483__a,0,null);
} 
...
var or__5002__auto__ = (function (){var G__12458 = c;
var G__12458__$1 = (((G__12458 == null))?null:G__12458.constructor);
if((G__12458__$1 == null)){
return null;
} else {
return G__12458__$1.displayName;
}
})();
...
var G__12460 = c;
var G__12460__$1 = (((G__12460 == null))?null:G__12460.constructor);
if((G__12460__$1 == null)){
return null;
} else {
return G__12460__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__12468 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12469 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12469);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12468);
}});
...
var c = this;
var G__12472_12488 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__12472_12488 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12472_12488);
}
...
var renders_12489 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12490 = cljs.core.first(cljs.core.vals(renders_12489));
...
if((cljs.core.count(renders_12489) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12489))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12490)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12490], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__12473 = o;
reagent.impl.component.goog$module$goog$object.set(G__12473,cljs.core.name(k),v);
...
while (G__12492__i < G__12492__a.length) {G__12492__a[G__12492__i] = arguments[G__12492__i + 0]; ++G__12492__i;}
  args = new cljs.core.IndexedSeq(G__12492__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__12474 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12475 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12475);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12474);
}});
...
var vec__12476 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12476,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12476,(1),null);
...
var G__12479 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__12479 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__12479);
}
});
}),[]);

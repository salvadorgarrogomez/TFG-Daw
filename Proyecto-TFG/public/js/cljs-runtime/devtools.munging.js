...
var o15418 = temp__5802__auto__;
var temp__5802__auto____$1 = (o15418["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o15419 = temp__5802__auto____$1;
return (o15419["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10321__auto__ = f;
return (o__10321__auto__["toString"]).call(o__10321__auto__);
} else {
return "";
}
}catch (e15425){var _ = e15425;
return "";
}});
...
try{var o__10321__auto___15723 = t;
(o__10321__auto___15723["cljs$lang$ctorPrWriter"]).call(o__10321__auto___15723,t,writer);
}catch (e15426){var __15725 = e15426;
}
...
var char_code = (function (){var o__10321__auto__ = (new String(char$));
return (o__10321__auto__["charCodeAt"]).call(o__10321__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10321__auto__ = String;
return (o__10321__auto__["fromCharCode"]).call(o__10321__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15433 = num_code;
switch (G__15433) {
case (1):
return (185);
...
var o__10321__auto__ = String;
return (o__10321__auto__["fromCharCode"]).call(o__10321__auto__,superscript_code);
});
/**
...
}catch (e15456){var _e__10328__auto__ = e15456;
return false;
}})())){
...
var vec__15460 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15460,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15476){
var vec__15477 = p__15476;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15477,(0),null);
...
var G__15742 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__15743 = cljs.core.butlast(remaining_tokens);
name_tokens = G__15742;
remaining_tokens = G__15743;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15472){
var G__15473 = cljs.core.first(seq15472);
var seq15472__$1 = cljs.core.next(seq15472);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15473,seq15472__$1);
}));
...
var vec__15484 = cljs.core.split_with((function (p1__15482_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__15482_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15484,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15484,(1),null);
...
var vec__15500 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15500,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15500,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__15747 = cljs.core.rest(remaining_tokens);
var G__15748 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
...
var vec__15516 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15516,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15516,(1),null);
var vec__15519 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15519,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15519,(1),null);
var vec__15522 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15522,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15522,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15522,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15522,(3),null);
...
var vec__15528 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15528,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15528,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15528,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15528,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15528,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15528,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__15533 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15533,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15533,(1),null);
var vec__15540 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15540,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15540,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__15545 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__15545) : devtools.munging.parse_fn_info_deep.call(null, G__15545));
})()));
}
} else {
return fn_info;
...
var G__15768 = (arity + (1));
var G__15769 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15555){
var vec__15556 = p__15555;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15556,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15556,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15611_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__15611_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15612_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__15612_SHARP_);
}),sorted_infos);
...
var G__15781 = (i__5727__auto___15779 + (1));
i__5727__auto___15779 = G__15781;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15625){
var vec__15627 = p__15625;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15627,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15623){
var G__15624 = cljs.core.first(seq15623);
var seq15623__$1 = cljs.core.next(seq15623);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15624,seq15623__$1);
}));
...
var map__15650 = options;
var map__15650__$1 = cljs.core.__destructure_map(map__15650);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15650__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15650__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15650__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15650__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15651 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15651,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15651,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15651,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15651,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15651,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15651,(5),null);
...
var o__10321__auto__ = f;
return (o__10321__auto__["getBasis"]).call(o__10321__auto__);
});
/**
...
}catch (e15663){var _e__10328__auto__ = e15663;
...
var G__15795 = (obj[cljs.core.first(path)]);
var G__15796 = cljs.core.rest(path);
obj = G__15795;
path = G__15796;
continue;
} else {
...
var _STAR_ = (function (accum,p__15684){
var vec__15685 = p__15684;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15685,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15685,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15693){
var vec__15694 = p__15693;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15694,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15694,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15694,(2),null);
...
var post_process = (function (p__15707){
var vec__15708 = p__15707;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15708,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15708,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15700_SHARP_){
return (obj[cljs.core.first(p1__15700_SHARP_)]);
}),sorted_matches);

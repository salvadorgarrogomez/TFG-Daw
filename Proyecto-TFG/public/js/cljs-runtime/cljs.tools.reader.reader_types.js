...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_22890 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_22890(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22891 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22891(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22893 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22893(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22894 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22894(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22895 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22895(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22906 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22906(reader);
}
});
...
var G__22943 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__22944 = s.append(c);
c = G__22943;
s = G__22944;
continue;
}

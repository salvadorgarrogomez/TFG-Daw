...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_25117 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_25117(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_25122 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_25122(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25123 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25123(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25128 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25128(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25132 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25132(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25133 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25133(reader);
}
});
...
var G__25182 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__25183 = s.append(c);
c = G__25182;
s = G__25183;
continue;
}

...
return cljs.core.chunk_cons(cljs.core.chunk(b__13336),administracion$core$render_categorias_$_iter__13333(cljs.core.chunk_rest(s__13334__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13336),null);
}
} else {
var map__13363 = cljs.core.first(s__13334__$2);
var map__13363__$1 = cljs.core.__destructure_map(map__13363);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13363__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13363__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
var descripcion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13363__$1,new cljs.core.Keyword(null,"descripcion","descripcion",-1196002063));
var activo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13363__$1,new cljs.core.Keyword(null,"activo","activo",-1391186334));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(activo)?"table-success":"table-danger")], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"tdButton"], null),id], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),nombre], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.d-none.d-sm-table-cell","td.d-none.d-sm-table-cell",-1180555461),descripcion], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"tdButton"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__13363,map__13363__$1,id,nombre,descripcion,activo,s__13334__$2,temp__5804__auto__,texto,categorias_filtradas){
return (function (){
return (location.hash = ["/editar/categoria/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)].join(''));
});})(map__13363,map__13363__$1,id,nombre,descripcion,activo,s__13334__$2,temp__5804__auto__,texto,categorias_filtradas))
], null),"Editar"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"tdButton"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__13363,map__13363__$1,id,nombre,descripcion,activo,s__13334__$2,temp__5804__auto__,texto,categorias_filtradas){
return (function (){
return app.db.activo_categoria(id);
});})(map__13363,map__13363__$1,id,nombre,descripcion,activo,s__13334__$2,temp__5804__auto__,texto,categorias_filtradas))
], null),"\u2714\uFE0F/\u274C"], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),administracion$core$render_categorias_$_iter__13333(cljs.core.rest(s__13334__$2)));
}
} else {
return null;
}
...
var productos_filtrados = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__13368_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(categoria,"todas")) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(clojure.string.lower_case(new cljs.core.Keyword(null,"nombre_categoria","nombre_categoria",-32557042).cljs$core$IFn$_invoke$arity$1(p1__13368_SHARP_)),categoria)));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__13367_SHARP_){
return clojure.string.includes_QMARK_(clojure.string.lower_case(new cljs.core.Keyword(null,"nombre","nombre",1047347004).cljs$core$IFn$_invoke$arity$1(p1__13367_SHARP_)),texto);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13379),administracion$core$render_productos_$_iter__13376(cljs.core.chunk_rest(s__13377__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13379),null);
}
} else {
var map__13387 = cljs.core.first(s__13377__$2);
var map__13387__$1 = cljs.core.__destructure_map(map__13387);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13387__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13387__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),nombre], null),nombre], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),administracion$core$render_productos_$_iter__13376(cljs.core.rest(s__13377__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13394),administracion$core$render_productos_$_iter__13391(cljs.core.chunk_rest(s__13392__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13394),null);
}
} else {
var map__13399 = cljs.core.first(s__13392__$2);
var map__13399__$1 = cljs.core.__destructure_map(map__13399);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13399__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13399__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13399__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var precio = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13399__$1,new cljs.core.Keyword(null,"precio","precio",-1246474385));
var nombre_categoria = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13399__$1,new cljs.core.Keyword(null,"nombre_categoria","nombre_categoria",-32557042));
var tipo_plato = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13399__$1,new cljs.core.Keyword(null,"tipo_plato","tipo_plato",-1144165380));
var tipo_porcion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13399__$1,new cljs.core.Keyword(null,"tipo_porcion","tipo_porcion",1174589739));
var activo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13399__$1,new cljs.core.Keyword(null,"activo","activo",-1391186334));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(activo)?"table-success":"table-danger")], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"id"], null),id], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),nombre], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.d-none.d-lg-table-cell","td.d-none.d-lg-table-cell",-792699645),description], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.d-none.d-sm-table-cell","td.d-none.d-sm-table-cell",-1180555461),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(precio)," \u20AC"].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.d-none.d-lg-table-cell","td.d-none.d-lg-table-cell",-792699645),nombre_categoria], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.d-none.d-lg-table-cell","td.d-none.d-lg-table-cell",-792699645),tipo_plato], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),tipo_porcion], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"tdButton"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__13399,map__13399__$1,id,nombre,description,precio,nombre_categoria,tipo_plato,tipo_porcion,activo,s__13392__$2,temp__5804__auto__,productos_ids,texto,categoria,productos_filtrados){
return (function (){
return (location.hash = ["/editar/producto/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)].join(''));
});})(map__13399,map__13399__$1,id,nombre,description,precio,nombre_categoria,tipo_plato,tipo_porcion,activo,s__13392__$2,temp__5804__auto__,productos_ids,texto,categoria,productos_filtrados))
], null),"Editar"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"tdButton"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__13399,map__13399__$1,id,nombre,description,precio,nombre_categoria,tipo_plato,tipo_porcion,activo,s__13392__$2,temp__5804__auto__,productos_ids,texto,categoria,productos_filtrados){
return (function (){
return app.db.activo_producto(id);
});})(map__13399,map__13399__$1,id,nombre,description,precio,nombre_categoria,tipo_plato,tipo_porcion,activo,s__13392__$2,temp__5804__auto__,productos_ids,texto,categoria,productos_filtrados))
], null),"\u2714\uFE0F/\u274C"], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),administracion$core$render_productos_$_iter__13391(cljs.core.rest(s__13392__$2)));
}
} else {
return null;
}
...
cljs.core.reset_BANG_(administracion.core.datos_usuario,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"nombre","nombre",1047347004),new cljs.core.Keyword(null,"nombre","nombre",1047347004).cljs$core$IFn$_invoke$arity$1(p1__13404_SHARP_),new cljs.core.Keyword(null,"rol","rol",-1201341516),new cljs.core.Keyword(null,"rol","rol",-1201341516).cljs$core$IFn$_invoke$arity$1(p1__13404_SHARP_)], null));

localStorage.setItem("id",new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__13404_SHARP_));

cljs.core.reset_BANG_(administracion.core.sesion_verificada_QMARK_,true);

if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"rol","rol",-1201341516).cljs$core$IFn$_invoke$arity$1(p1__13404_SHARP_),"admin")){
return console.log("Es admin");
} else {
return null;
}
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p1__13405_SHARP_){
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error en la solicitud: ",p1__13405_SHARP_], 0));
...
var with_let13412 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let13412","with-let13412",1220457534));
var temp__5808__auto___13451 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___13451 == null)){
} else {
var c__12240__auto___13452 = temp__5808__auto___13451;
if((with_let13412.generation === c__12240__auto___13452.ratomGeneration)){
...
(with_let13412.generation = c__12240__auto___13452.ratomGeneration);
}

var init13413 = (with_let13412.length === (0));
var _ = ((((init13413) || (cljs.core.not(with_let13412.hasOwnProperty((0))))))?(with_let13412[(0)] = (function (){

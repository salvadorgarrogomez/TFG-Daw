...
return cljs.core.some((function (p1__26847_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__26847_SHARP_),id)){
...
return cljs.core.some((function (p1__26853_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__26853_SHARP_),id)){
...
var vec__26860 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(valor,/\./);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26860,(0),null);
var decimales = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26860,(1),null);
...
var valor_parseado = (function (){var G__26868 = campo;
switch (G__26868) {
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__26925_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__26925_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__26928_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__26928_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__26929_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__26929_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__26932_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__26932_SHARP_.target.value);
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),""], null),"-- Selecciona una categor\u00EDa --"], null),(function (){var iter__5480__auto__ = (function administracion$editar$render_edicion_producto_$_iter__26988(s__26989){
return (new cljs.core.LazySeq(null,(function (){
var s__26989__$1 = s__26989;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26989__$1);
if(temp__5804__auto__){
var s__26989__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26989__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__26989__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__26991 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__26990 = (0);
while(true){
if((i__26990 < size__5479__auto__)){
var map__27003 = cljs.core._nth(c__5478__auto__,i__26990);
var map__27003__$1 = cljs.core.__destructure_map(map__27003);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27003__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27003__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26991),administracion$editar$render_edicion_producto_$_iter__26988(cljs.core.chunk_rest(s__26989__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26991),null);
}
} else {
var map__27007 = cljs.core.first(s__26989__$2);
var map__27007__$1 = cljs.core.__destructure_map(map__27007);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27007__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27007__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),id], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)," - ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(nombre)].join('')], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),administracion$editar$render_edicion_producto_$_iter__26988(cljs.core.rest(s__26989__$2)));
}
} else {
return null;
}
...
})()], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(administracion.editar.campo_seleccionado),"precio"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.01",new cljs.core.Keyword(null,"min","min",444991522),"0",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(producto),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__26936_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__26936_SHARP_.target.value);
})], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(producto),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__26937_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__26937_SHARP_.target.value);
})], null)], null)
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__27019_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.campo_seleccionado,p1__27019_SHARP_.target.value);
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),""], null),"-- Selecciona un campo --"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"nombre"], null),"Nombre"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"descripcion"], null),"Descripci\u00F3n"], null)], null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(administracion.editar.campo_seleccionado),""))?new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"15px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),"Nuevo valor para el campo seleccionado: "], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(categoria),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__27020_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__27020_SHARP_.target.value);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27043),administracion$editar$columnas_alergenos_$_iter__27040(cljs.core.chunk_rest(s__27041__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27043),null);
}
} else {
var vec__27053 = cljs.core.first(s__27041__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27053,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27053,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(label),": "].join('')], null),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(vals,k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-success","span.text-success",429372420),"\u2714\uFE0F"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-danger","span.text-danger",1634101399),"\u274C"], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),administracion$editar$columnas_alergenos_$_iter__27040(cljs.core.rest(s__27041__$2)));
}
} else {
return null;
}
...
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-6","div.col-6",-2040623677),(function (){var iter__5480__auto__ = (function administracion$editar$columnas_alergenos_$_iter__27056(s__27057){
return (new cljs.core.LazySeq(null,(function (){
var s__27057__$1 = s__27057;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__27057__$1);
if(temp__5804__auto__){
var s__27057__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27057__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__27057__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__27059 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__27058 = (0);
while(true){
if((i__27058 < size__5479__auto__)){
var vec__27060 = cljs.core._nth(c__5478__auto__,i__27058);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27060,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27060,(1),null);
cljs.core.chunk_append(b__27059,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(label),": "].join('')], null),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(vals,k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-success","span.text-success",429372420),"\u2714\uFE0F"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-danger","span.text-danger",1634101399),"\u274C"], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)));

var G__27093 = (i__27058 + (1));
i__27058 = G__27093;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27059),administracion$editar$columnas_alergenos_$_iter__27056(cljs.core.chunk_rest(s__27057__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27059),null);
}
} else {
var vec__27066 = cljs.core.first(s__27057__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27066,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27066,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(label),": "].join('')], null),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(vals,k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-success","span.text-success",429372420),"\u2714\uFE0F"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-danger","span.text-danger",1634101399),"\u274C"], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),administracion$editar$columnas_alergenos_$_iter__27056(cljs.core.rest(s__27057__$2)));
}
} else {
return null;
}
...
var temp__5808__auto___27094 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___27094 == null)){
} else {
var c__12240__auto___27095 = temp__5808__auto___27094;
if((with_let27069.generation === c__12240__auto___27095.ratomGeneration)){
...
(with_let27069.generation = c__12240__auto___27095.ratomGeneration);
}

var init27070 = (with_let27069.length === (0));
var _ = ((((init27070) || (cljs.core.not(with_let27069.hasOwnProperty((0))))))?(with_let27069[(0)] = cljs.core.reset_BANG_(administracion.editar.producto,administracion.editar.get_producto_por_id(id))):(with_let27069[(0)]));
var res27071 = (function (){var with_let27073 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let27073","with-let27073",436840420));
var temp__5808__auto___27096 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___27096 == null)){
} else {
var c__12240__auto___27097 = temp__5808__auto___27096;
if((with_let27073.generation === c__12240__auto___27097.ratomGeneration)){
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).error(["Warning: The same with-let is being used more ","than once in the same reactive context."].join(''));
} else {
}
...
(with_let27073.generation = c__12240__auto___27097.ratomGeneration);
}

var init27074 = (with_let27073.length === (0));
var ___$1 = ((((init27074) || (cljs.core.not(with_let27073.hasOwnProperty((0))))))?(with_let27073[(0)] = cljs.core.reset_BANG_(administracion.editar.categoria,administracion.editar.get_categoria_por_id(id))):(with_let27073[(0)]));
var res27075 = (function (){var G__27077 = tipo;
switch (G__27077) {
case "producto":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27077)].join('')));

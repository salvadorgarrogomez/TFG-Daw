...
return cljs.core.some((function (p1__15351_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__15351_SHARP_),id)){
return p1__15351_SHARP_;
} else {
return null;
}
...
return cljs.core.some((function (p1__15358_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__15358_SHARP_),id)){
return p1__15358_SHARP_;
} else {
return null;
}
...
var vec__15364 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(valor,/\./);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15364,(0),null);
var decimales = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15364,(1),null);
...
var valor_parseado = (function (){var G__15373 = campo;
switch (G__15373) {
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__15417_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__15417_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__15421_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__15421_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__15423_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__15423_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__15425_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__15425_SHARP_.target.value);
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),""], null),"-- Selecciona una categor\u00EDa --"], null),(function (){var iter__5480__auto__ = (function administracion$editar$render_edicion_producto_$_iter__15469(s__15470){
return (new cljs.core.LazySeq(null,(function (){
var s__15470__$1 = s__15470;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__15470__$1);
if(temp__5804__auto__){
var s__15470__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__15470__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__15470__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__15472 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__15471 = (0);
while(true){
if((i__15471 < size__5479__auto__)){
var map__15480 = cljs.core._nth(c__5478__auto__,i__15471);
var map__15480__$1 = cljs.core.__destructure_map(map__15480);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15480__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15480__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
cljs.core.chunk_append(b__15472,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),id], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)," - ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(nombre)].join('')], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__15590 = (i__15471 + (1));
i__15471 = G__15590;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__15472),administracion$editar$render_edicion_producto_$_iter__15469(cljs.core.chunk_rest(s__15470__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__15472),null);
}
} else {
var map__15488 = cljs.core.first(s__15470__$2);
var map__15488__$1 = cljs.core.__destructure_map(map__15488);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15488__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15488__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),id], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)," - ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(nombre)].join('')], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),administracion$editar$render_edicion_producto_$_iter__15469(cljs.core.rest(s__15470__$2)));
}
} else {
return null;
}
...
})()], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(administracion.editar.campo_seleccionado),"precio"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.01",new cljs.core.Keyword(null,"min","min",444991522),"0",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(producto),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__15427_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__15427_SHARP_.target.value);
})], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(producto),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__15429_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__15429_SHARP_.target.value);
})], null)], null)
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__15513_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.campo_seleccionado,p1__15513_SHARP_.target.value);
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),""], null),"-- Selecciona un campo --"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"nombre"], null),"Nombre"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"descripcion"], null),"Descripci\u00F3n"], null)], null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(administracion.editar.campo_seleccionado),""))?new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"15px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),"Nuevo valor para el campo seleccionado: "], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(categoria),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__15515_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__15515_SHARP_.target.value);
...
var with_let15530 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let15530","with-let15530",1236401073));
var temp__5808__auto___15593 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___15593 == null)){
} else {
var c__12240__auto___15594 = temp__5808__auto___15593;
if((with_let15530.generation === c__12240__auto___15594.ratomGeneration)){
...
(with_let15530.generation = c__12240__auto___15594.ratomGeneration);
}

var init15531 = (with_let15530.length === (0));
var _ = ((((init15531) || (cljs.core.not(with_let15530.hasOwnProperty((0))))))?(with_let15530[(0)] = cljs.core.reset_BANG_(administracion.editar.producto,administracion.editar.get_producto_por_id(id))):(with_let15530[(0)]));
var res15532 = (function (){var with_let15535 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let15535","with-let15535",286485285));
var temp__5808__auto___15595 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___15595 == null)){
} else {
var c__12240__auto___15596 = temp__5808__auto___15595;
if((with_let15535.generation === c__12240__auto___15596.ratomGeneration)){
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).error(["Warning: The same with-let is being used more ","than once in the same reactive context."].join(''));
} else {
}
...
(with_let15535.generation = c__12240__auto___15596.ratomGeneration);
}

var init15536 = (with_let15535.length === (0));
var ___$1 = ((((init15536) || (cljs.core.not(with_let15535.hasOwnProperty((0))))))?(with_let15535[(0)] = cljs.core.reset_BANG_(administracion.editar.categoria,administracion.editar.get_categoria_por_id(id))):(with_let15535[(0)]));
var res15537 = (function (){var G__15540 = tipo;
switch (G__15540) {
case "producto":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15540)].join('')));

...
return cljs.core.some((function (p1__14118_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__14118_SHARP_),id)){
...
return cljs.core.some((function (p1__14119_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__14119_SHARP_),id)){
return p1__14119_SHARP_;
} else {
return null;
}
...
var vec__14120 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(valor,/\./);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14120,(0),null);
var decimales = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14120,(1),null);
...
var valor_parseado = (function (){var G__14123 = campo;
switch (G__14123) {
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__14125_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__14125_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__14126_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__14126_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__14127_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__14127_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__14128_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__14128_SHARP_.target.value);
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),""], null),"-- Selecciona una categor\u00EDa --"], null),(function (){var iter__5480__auto__ = (function administracion$editar$render_edicion_producto_$_iter__14133(s__14134){
return (new cljs.core.LazySeq(null,(function (){
var s__14134__$1 = s__14134;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__14134__$1);
if(temp__5804__auto__){
var s__14134__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__14134__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__14134__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__14136 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__14135 = (0);
while(true){
if((i__14135 < size__5479__auto__)){
var map__14137 = cljs.core._nth(c__5478__auto__,i__14135);
var map__14137__$1 = cljs.core.__destructure_map(map__14137);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14137__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14137__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
cljs.core.chunk_append(b__14136,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),id], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)," - ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(nombre)].join('')], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__14173 = (i__14135 + (1));
i__14135 = G__14173;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14136),administracion$editar$render_edicion_producto_$_iter__14133(cljs.core.chunk_rest(s__14134__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14136),null);
}
} else {
var map__14138 = cljs.core.first(s__14134__$2);
var map__14138__$1 = cljs.core.__destructure_map(map__14138);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14138__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14138__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),id], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)," - ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(nombre)].join('')], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),administracion$editar$render_edicion_producto_$_iter__14133(cljs.core.rest(s__14134__$2)));
}
} else {
return null;
}
...
})()], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(administracion.editar.campo_seleccionado),"precio"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.01",new cljs.core.Keyword(null,"min","min",444991522),"0",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(producto),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__14129_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__14129_SHARP_.target.value);
})], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(producto),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__14130_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__14130_SHARP_.target.value);
})], null)], null)
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__14139_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.campo_seleccionado,p1__14139_SHARP_.target.value);
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),""], null),"-- Selecciona un campo --"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"nombre"], null),"Nombre"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"descripcion"], null),"Descripci\u00F3n"], null)], null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(administracion.editar.campo_seleccionado),""))?new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"15px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),"Nuevo valor para el campo seleccionado: "], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(categoria),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__14140_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__14140_SHARP_.target.value);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14147),administracion$editar$columnas_alergenos_$_iter__14144(cljs.core.chunk_rest(s__14145__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14147),null);
}
} else {
var vec__14151 = cljs.core.first(s__14145__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14151,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14151,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(label),": "].join('')], null),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(vals,k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-success","span.text-success",429372420),"\u2714\uFE0F"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-danger","span.text-danger",1634101399),"\u274C"], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),administracion$editar$columnas_alergenos_$_iter__14144(cljs.core.rest(s__14145__$2)));
}
} else {
return null;
}
...
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-6","div.col-6",-2040623677),(function (){var iter__5480__auto__ = (function administracion$editar$columnas_alergenos_$_iter__14154(s__14155){
return (new cljs.core.LazySeq(null,(function (){
var s__14155__$1 = s__14155;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__14155__$1);
if(temp__5804__auto__){
var s__14155__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__14155__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__14155__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__14157 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__14156 = (0);
while(true){
if((i__14156 < size__5479__auto__)){
var vec__14158 = cljs.core._nth(c__5478__auto__,i__14156);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14158,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14158,(1),null);
cljs.core.chunk_append(b__14157,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(label),": "].join('')], null),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(vals,k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-success","span.text-success",429372420),"\u2714\uFE0F"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-danger","span.text-danger",1634101399),"\u274C"], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)));

var G__14175 = (i__14156 + (1));
i__14156 = G__14175;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14157),administracion$editar$columnas_alergenos_$_iter__14154(cljs.core.chunk_rest(s__14155__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14157),null);
}
} else {
var vec__14161 = cljs.core.first(s__14155__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14161,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14161,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(label),": "].join('')], null),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(vals,k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-success","span.text-success",429372420),"\u2714\uFE0F"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-danger","span.text-danger",1634101399),"\u274C"], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),administracion$editar$columnas_alergenos_$_iter__14154(cljs.core.rest(s__14155__$2)));
}
} else {
return null;
}
...
var with_let14164 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let14164","with-let14164",644168833));
var temp__5808__auto___14176 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___14176 == null)){
} else {
var c__12240__auto___14177 = temp__5808__auto___14176;
if((with_let14164.generation === c__12240__auto___14177.ratomGeneration)){
...
(with_let14164.generation = c__12240__auto___14177.ratomGeneration);
}

var init14165 = (with_let14164.length === (0));
var _ = ((((init14165) || (cljs.core.not(with_let14164.hasOwnProperty((0))))))?(with_let14164[(0)] = cljs.core.reset_BANG_(administracion.editar.producto,administracion.editar.get_producto_por_id(id))):(with_let14164[(0)]));
var res14166 = (function (){var with_let14167 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let14167","with-let14167",-2127812630));
var temp__5808__auto___14178 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___14178 == null)){
} else {
var c__12240__auto___14179 = temp__5808__auto___14178;
if((with_let14167.generation === c__12240__auto___14179.ratomGeneration)){
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).error(["Warning: The same with-let is being used more ","than once in the same reactive context."].join(''));
} else {
}
...
(with_let14167.generation = c__12240__auto___14179.ratomGeneration);
}

var init14168 = (with_let14167.length === (0));
var ___$1 = ((((init14168) || (cljs.core.not(with_let14167.hasOwnProperty((0))))))?(with_let14167[(0)] = cljs.core.reset_BANG_(administracion.editar.categoria,administracion.editar.get_categoria_por_id(id))):(with_let14167[(0)]));
var res14169 = (function (){var G__14170 = tipo;
switch (G__14170) {
case "producto":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14170)].join('')));

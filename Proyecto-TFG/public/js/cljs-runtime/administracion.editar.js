...
return cljs.core.some((function (p1__13649_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__13649_SHARP_),id)){
return p1__13649_SHARP_;
} else {
return null;
}
...
return cljs.core.some((function (p1__13650_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__13650_SHARP_),id)){
...
var vec__13651 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(valor,/\./);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13651,(0),null);
var decimales = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13651,(1),null);
...
var valor_parseado = (function (){var G__13654 = campo;
switch (G__13654) {
...
var body_extendido = cljs.core.clj__GT_js(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.PersistentArrayMap.EMPTY,campo,valor_parseado,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["usuario_id",usuario_id], 0)));
var url = ["/api/productos/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)].join('');
var opciones = ({"method": "PUT", "with-credentials?": true, "headers": ({"Content-Type": "application/json"}), "body": JSON.stringify(body_extendido)});
...
var opciones = ({"method": "PUT", "with-credentials?": true, "headers": ({"Content-Type": "application/json"}), "body": JSON.stringify(body)});
return fetch(url,opciones).then((function (respuesta){
if(cljs.core.truth_(respuesta.ok)){
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__13656_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__13656_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__13657_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__13657_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__13658_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__13658_SHARP_.target.value);
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__13659_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__13659_SHARP_.target.value);
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),""], null),"-- Selecciona una categor\u00EDa --"], null),(function (){var iter__5480__auto__ = (function administracion$editar$render_edicion_producto_$_iter__13664(s__13665){
return (new cljs.core.LazySeq(null,(function (){
var s__13665__$1 = s__13665;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__13665__$1);
if(temp__5804__auto__){
var s__13665__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13665__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__13665__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__13667 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__13666 = (0);
while(true){
if((i__13666 < size__5479__auto__)){
var map__13668 = cljs.core._nth(c__5478__auto__,i__13666);
var map__13668__$1 = cljs.core.__destructure_map(map__13668);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13668__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13668__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
cljs.core.chunk_append(b__13667,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),id], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)," - ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(nombre)].join('')], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__13704 = (i__13666 + (1));
i__13666 = G__13704;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13667),administracion$editar$render_edicion_producto_$_iter__13664(cljs.core.chunk_rest(s__13665__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13667),null);
}
} else {
var map__13669 = cljs.core.first(s__13665__$2);
var map__13669__$1 = cljs.core.__destructure_map(map__13669);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13669__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var nombre = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13669__$1,new cljs.core.Keyword(null,"nombre","nombre",1047347004));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),id], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)," - ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(nombre)].join('')], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),administracion$editar$render_edicion_producto_$_iter__13664(cljs.core.rest(s__13665__$2)));
}
} else {
return null;
}
...
})()], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(administracion.editar.campo_seleccionado),"precio"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.01",new cljs.core.Keyword(null,"min","min",444991522),"0",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(producto),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__13660_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__13660_SHARP_.target.value);
})], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(producto),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__13661_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__13661_SHARP_.target.value);
})], null)], null)
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__13670_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.campo_seleccionado,p1__13670_SHARP_.target.value);
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),""], null),"-- Selecciona un campo --"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"nombre"], null),"Nombre"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"descripcion"], null),"Descripci\u00F3n"], null)], null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(administracion.editar.campo_seleccionado),""))?new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"15px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),"Nuevo valor para el campo seleccionado: "], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(administracion.editar.nuevo_valor),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(categoria),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(administracion.editar.campo_seleccionado)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__13671_SHARP_){
return cljs.core.reset_BANG_(administracion.editar.nuevo_valor,p1__13671_SHARP_.target.value);
...
var vec__13672 = cljs.core.split_at(mitad,administracion.editar.alergenos);
var col1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13672,(0),null);
var col2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13672,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.row","div.row",133678515),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-6","div.col-6",-2040623677),(function (){var iter__5480__auto__ = (function administracion$editar$columnas_alergenos_$_iter__13675(s__13676){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13678),administracion$editar$columnas_alergenos_$_iter__13675(cljs.core.chunk_rest(s__13676__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13678),null);
}
} else {
var vec__13682 = cljs.core.first(s__13676__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13682,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13682,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(label),": "].join('')], null),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(vals,k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-success","span.text-success",429372420),"\u2714\uFE0F"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-danger","span.text-danger",1634101399),"\u274C"], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),administracion$editar$columnas_alergenos_$_iter__13675(cljs.core.rest(s__13676__$2)));
}
} else {
return null;
}
...
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-6","div.col-6",-2040623677),(function (){var iter__5480__auto__ = (function administracion$editar$columnas_alergenos_$_iter__13685(s__13686){
return (new cljs.core.LazySeq(null,(function (){
var s__13686__$1 = s__13686;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__13686__$1);
if(temp__5804__auto__){
var s__13686__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13686__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__13686__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__13688 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__13687 = (0);
while(true){
if((i__13687 < size__5479__auto__)){
var vec__13689 = cljs.core._nth(c__5478__auto__,i__13687);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13689,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13689,(1),null);
cljs.core.chunk_append(b__13688,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(label),": "].join('')], null),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(vals,k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-success","span.text-success",429372420),"\u2714\uFE0F"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-danger","span.text-danger",1634101399),"\u274C"], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)));

var G__13706 = (i__13687 + (1));
i__13687 = G__13706;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13688),administracion$editar$columnas_alergenos_$_iter__13685(cljs.core.chunk_rest(s__13686__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13688),null);
}
} else {
var vec__13692 = cljs.core.first(s__13686__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13692,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13692,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(label),": "].join('')], null),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(vals,k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-success","span.text-success",429372420),"\u2714\uFE0F"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-danger","span.text-danger",1634101399),"\u274C"], null))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),administracion$editar$columnas_alergenos_$_iter__13685(cljs.core.rest(s__13686__$2)));
}
} else {
return null;
}
...
var with_let13695 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let13695","with-let13695",1047122168));
var temp__5808__auto___13707 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___13707 == null)){
} else {
var c__12240__auto___13708 = temp__5808__auto___13707;
if((with_let13695.generation === c__12240__auto___13708.ratomGeneration)){
...
(with_let13695.generation = c__12240__auto___13708.ratomGeneration);
}

var init13696 = (with_let13695.length === (0));
var _ = ((((init13696) || (cljs.core.not(with_let13695.hasOwnProperty((0))))))?(with_let13695[(0)] = cljs.core.reset_BANG_(administracion.editar.producto,administracion.editar.get_producto_por_id(id))):(with_let13695[(0)]));
var res13697 = (function (){var with_let13698 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let13698","with-let13698",1957430148));
var temp__5808__auto___13709 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___13709 == null)){
} else {
var c__12240__auto___13710 = temp__5808__auto___13709;
if((with_let13698.generation === c__12240__auto___13710.ratomGeneration)){
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).error(["Warning: The same with-let is being used more ","than once in the same reactive context."].join(''));
} else {
}
...
(with_let13698.generation = c__12240__auto___13710.ratomGeneration);
}

var init13699 = (with_let13698.length === (0));
var ___$1 = ((((init13699) || (cljs.core.not(with_let13698.hasOwnProperty((0))))))?(with_let13698[(0)] = cljs.core.reset_BANG_(administracion.editar.categoria,administracion.editar.get_categoria_por_id(id))):(with_let13698[(0)]));
var res13700 = (function (){var G__13701 = tipo;
switch (G__13701) {
case "producto":

...
return [(function (){var pred__12294 = cljs.core.instance_QMARK_;
var expr__12295 = reactive_val;
if(cljs.core.truth_((pred__12294.cljs$core$IFn$_invoke$arity$2 ? pred__12294.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__12295) : pred__12294.call(null, reagent.ratom.RAtom,expr__12295)))){
return "ra";
} else {
if(cljs.core.truth_((pred__12294.cljs$core$IFn$_invoke$arity$2 ? pred__12294.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__12295) : pred__12294.call(null, reagent.ratom.RCursor,expr__12295)))){
return "rc";
} else {
if(cljs.core.truth_((pred__12294.cljs$core$IFn$_invoke$arity$2 ? pred__12294.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__12295) : pred__12294.call(null, reagent.ratom.Reaction,expr__12295)))){
return "rx";
} else {
if(cljs.core.truth_((pred__12294.cljs$core$IFn$_invoke$arity$2 ? pred__12294.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__12295) : pred__12294.call(null, reagent.ratom.Track,expr__12295)))){
return "tr";
} else {
return "other";
}

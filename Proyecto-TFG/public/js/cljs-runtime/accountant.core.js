...
var and__5000__auto____$1 = (function (){var fexpr__12253 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__12253.cljs$core$IFn$_invoke$arity$1 ? fexpr__12253.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__12253.call(null, link_target));
})();
if(cljs.core.truth_(and__5000__auto____$1)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__12256){
var map__12258 = p__12256;
var map__12258__$1 = cljs.core.__destructure_map(map__12258);
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12258__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12258__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12258__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var seq__12262 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__12263 = null;
var count__12264 = (0);
var i__12265 = (0);
while(true){
if((i__12265 < count__12264)){
var key = chunk__12263.cljs$core$IIndexed$_nth$arity$2(null, i__12265);
...
var G__12310 = seq__12262;
var G__12311 = chunk__12263;
var G__12312 = count__12264;
var G__12313 = (i__12265 + (1));
seq__12262 = G__12310;
chunk__12263 = G__12311;
count__12264 = G__12312;
i__12265 = G__12313;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__12262);
if(temp__5804__auto__){
var seq__12262__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__12262__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__12262__$1);
var G__12314 = cljs.core.chunk_rest(seq__12262__$1);
var G__12315 = c__5525__auto__;
var G__12316 = cljs.core.count(c__5525__auto__);
var G__12317 = (0);
seq__12262 = G__12314;
chunk__12263 = G__12315;
count__12264 = G__12316;
i__12265 = G__12317;
continue;
} else {
var key = cljs.core.first(seq__12262__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__12318 = cljs.core.next(seq__12262__$1);
var G__12319 = null;
var G__12320 = (0);
var G__12321 = (0);
seq__12262 = G__12318;
chunk__12263 = G__12319;
count__12264 = G__12320;
i__12265 = G__12321;
continue;
}
} else {
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12282_SHARP_){
return cljs.core.name(p1__12282_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12284_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__12284_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__12297 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__12297) : accountant.core.nav_handler.call(null, G__12297));
} else {

...
var G__12515 = request;
var G__12516 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__12515,G__12516) : ajax.formats.get_format.call(null, G__12515,G__12516));
} else {
...
return cljs.core.some((function (p1__12528_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__12528_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__12530){
var map__12531 = p__12530;
var map__12531__$1 = cljs.core.__destructure_map(map__12531);
var request = map__12531__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12531__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__12534 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12534.cljs$core$IFn$_invoke$arity$1 ? fexpr__12534.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12534.call(null, response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__12537){
var map__12538 = p__12537;
var map__12538__$1 = cljs.core.__destructure_map(map__12538);
var request = map__12538__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12538__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__12536_SHARP_){
return ajax.formats.get_accept_entries(request,p1__12536_SHARP_);
